                ...
                <NavBody>
                    ...
                    >
                        <svg
                            ...
                            className="w-6 h-6 text-gray-100 hover:text-gray-400 transition-colors"
                        >
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                    ...
                    <MobileNavMenu isOpen={isMobileMenuOpen} onClose={() => setIsMobileMenuOpen(false)}>
                        {navItems.map((item, idx) => (
                            <a
                                ...
                                className="relative text-white hover:text-green-500 transition-colors text-lg font-medium">
