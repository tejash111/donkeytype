...
export const NavBody = ({ children, className, visible }) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full px-4 py-2 lg:flex dark:bg-transparent bg-transparent",
      ...
      {items.map((item, idx) => {
        ...
        return (
          <a
            ...
            onClick={onItemClick}
            className={`relative px-4 py-2 text-neutral-600 rounded-full ${
              isActive ? "bg-gray-50" : ""
            }`}
            key={`link-${idx}`}
            href={item.link}
...
export const NavbarLogo = () => {
  return (
    <a
      href="#"
      className="relative z-20 mr-4 flex items-center space-x-2   font-normal text-black"
    >
